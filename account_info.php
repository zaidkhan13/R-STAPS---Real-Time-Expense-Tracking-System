...
$query="SELECT * from regform where username='$user'";
...
echo"
    ...
    <section class='row-fadeIn-wrapper'>
      <article class='row fadeIn nfl'>
        ...
        <ul>
          <li><a href='#'>Name</a><span class='small'></span></li>
   ...
   <!-- Row 1 - fadeIn -->
    <section class='row-fadeIn-wrapper'>
      <article class='row fadeIn nfl'>
        ...
        <ul>
          <li><a href='#'>Email</a><span class='small'></span></li>
          <li>".$row["email"]."</li>
         </ul>   
   </article>
  </section>
   <!-- Row 1 - fadeIn -->
    <section class='row-fadeIn-wrapper'>
      <article class='row fadeIn nfl'>
        ...
        <ul>
          <li><a href='#'>Date of Birth</a><span class='small'></span></li>
          <li>".$row["date"]."</li>
         </ul>   
   </article>
  </section>
   <!-- Row 1 - fadeIn -->
    <section class='row-fadeIn-wrapper'>
      <article class='row fadeIn nfl'>
        ...
        <ul>
          <li><a href='#'>Gender</a><span class='small'></span></li>
          <li>".$row["gender"]."</li>
         </ul>   
   </article>
  </section>
   <!-- Row 1 - fadeIn -->
    <section class='row-fadeIn-wrapper'>
      <article class='row fadeIn nfl'>
        ...
        <ul>
          <li><a href='#'>Phone No.</a><span class='small'></span></li>
          <li>".$row["phone"]."</li>
         </ul>   
   </article>
  </section>";}
