...
<head>
	...
	<style >
		...
		body{background:#59ABE3;margin:0;background-image: url("bg3.jpg");}
.form{width:340px;height:500px;background:#e6e6e6;border-radius:8px;box-shadow:0 0 40px -10px #000;margin:calc(50vh - 220px) auto;padding:20px 30px;max-width:calc(100vw - 40px);box-sizing:border-box;font-family:'Montserrat',sans-serif;position:relative}
...
<form class="form" method="post" action="help_next.php">
  <h2>CONTACT US</h2>
  ...
  <div>
    <span class="fa fa-envelope-o"></span> zaidalikhan012@gmail.com
  </div>
</form>
