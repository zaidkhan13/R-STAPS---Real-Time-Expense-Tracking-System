...
$query="SELECT regform.firstname,regform.lastname,pay.reason,pay.amount,regform.phone,pay.time from pay,regform where pay.user=regform.username and pay.phone=(select phone from regform where username='$user')";
...
echo"
    ...
    <section class='row-fadeIn-wrapper'>
      <article class='row fadeIn nfl'>
        ...
        <ul>
          <li><a href='#'>".$row["firstname"]." ".$row["lastname"]."</a><span class='small'>Requested You</span></li>
          <li>".$row["reason"]."</li>
          <li>".$row["amount"]."</li>
          <li>".$row["phone"]."</li>
          <li>".$row["time"]."</li>
        ...
        <ul class='more-content'>
          <li>You can either pay or deny the request.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
echo"
  ...
  include("success.php");
  echo "<center><h1>No request for you !!!</h1><center>";
}} 
else{ 
